...
export const updateGymConfigAction = panelAction(
  "config.gym",
  { onDenied: (d) => ({ ...empty, error: d.error }) },
  async (tenant, _prev: GymConfigFormState, formData: FormData): Promise<GymConfigFormState> => {
    const raw = {
