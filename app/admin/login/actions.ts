...
/**
 * Login del admin de STRING. Anónima por definición.
 *
 * Seguridad:
 ...
 */
export const loginAdmin = anonAction(
  "login_admin",
  async (_prev: AdminLoginState, formData: FormData): Promise<AdminLoginState> => {
    ...
    // Verificar que sea admin activo (policy de auto-lectura).
